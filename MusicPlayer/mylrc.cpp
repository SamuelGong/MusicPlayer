...
//    mask_linear_gradient.setColorAt(0.9, QColor(222, 54, 4));
	...
	mask_linear_gradient.setColorAt(0.1, QColor(0, 254, 4));
	mask_linear_gradient.setColorAt(0.5, QColor(0, 252, 16));
	mask_linear_gradient.setColorAt(0.9, QColor(0, 254, 4));
